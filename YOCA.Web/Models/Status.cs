...
public class Statuses
{
    ...
    public Statuses()
    {
        ...
        DefaultStatuses.Add(-1, new Status { Id = -1, Name = "Cancelled", Description = "Cancelled", Color = MudBlazor.Color.Error, Icon = MudBlazor.Icons.Material.Rounded.CancelPresentation });
    }
}
